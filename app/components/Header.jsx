  ...
  return (
    < div className='flex flex-col items-center justify-center gap-4 w-11/12 max-w-3xl text-center mx-auto h-screen '>
      ...
      className='text-3xl sm:text-6xl lg:text-[66px] '>
        i am a Frontened developer based in India.
      </motion.h1>
      <motion.p 
      initial={{y:-20,opacity:0}}
      whileInView={{y:0,opacity:1}}
      ...
      className='max-w-2xl mx-auto'>
        I am a frontened developer from India having knowledge in various frontened skills.
      </motion.p>
      <div className=' flex flex-col sm:flex-row items-center gap-4 mt-4'>
        ...
        className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 dark:text-black bg-white' href="/sample-resume.pdf" download> my resume <Image src={assets.download_icon} alt='' className='w-4'/></motion.a>
      </div>
    </div>
  )
}
