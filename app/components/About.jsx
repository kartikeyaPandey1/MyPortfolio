    ...
    return (
        ...
        id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            className='flex flex-col lg:flex-row w-full items-center gap-20 my-20'>
                ...
                className='flex-1'>
                    <p>I’m a pre-final year Electronics and Communication Engineering student at SLIET with a passion for building impactful web applications. Skilled in modern frontend technologies like React, Next.js, and animations with GSAP, I also have a solid foundation in Data Structures and Algorithms, solving problems to sharpen my problem-solving mindset. Always eager to learn and innovate, I enjoy turning ideas into functional, user-friendly digital experiences.</p>
